...
@NodeInfo(shortName="=")
public abstract class CoverWriteUnsignedLongArrayElementNode extends CoverTypedExpressionNode {
    @Specialization
    protected long writeUnsignedLongArrayElement(long[] array, long index, long value) {
        try {
