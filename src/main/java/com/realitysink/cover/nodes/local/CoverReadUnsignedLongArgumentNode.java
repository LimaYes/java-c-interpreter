 ...
 */
public abstract class CoverReadUnsignedLongArgumentNode extends CoverTypedExpressionNode {
    ...
    public CoverReadUnsignedLongArgumentNode(int index) {
        this.index = index;
    }

    @Specialization
    public long getUnsignedLong(VirtualFrame frame) {
