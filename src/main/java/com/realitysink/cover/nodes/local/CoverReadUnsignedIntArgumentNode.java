 ...
 */
public abstract class CoverReadUnsignedIntArgumentNode extends CoverTypedExpressionNode {
    ...
    public CoverReadUnsignedIntArgumentNode(int index) {
        this.index = index;
    }

    @Specialization
    public INT32 getUnsignedInt(VirtualFrame frame) {
