...
@NodeInfo(shortName="=")
public abstract class CoverWriteFloatArrayElementNode extends CoverTypedExpressionNode {
    @Specialization
    protected float writeLongArrayElement(float[] array, long index, float value) {
        try {
