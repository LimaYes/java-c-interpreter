 ...
 */
public abstract class CoverReadSignedIntArgumentNode extends CoverTypedExpressionNode {
    ...
    public CoverReadSignedIntArgumentNode(int index) {
        this.index = index;
    }

    @Specialization
    public long getSignedInt(VirtualFrame frame) {
